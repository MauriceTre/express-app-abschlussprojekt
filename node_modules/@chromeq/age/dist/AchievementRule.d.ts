...
interface AchievementRuleProps {
     ...
     */
    key: string | number | string[] | number[] | (string | number)[] | ((player: GamePlayer, engine: GameEngine) => string | number | string[] | number[] | (string | number)[]);
    /**
...
export declare class AchievementRule {
    multiplicity: AchievementRuleProps['multiplicity'];
    transient: AchievementRuleProps['transient'];
